...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('room_number', models.IntegerField(blank=True, verbose_name='xona raqami')),
            ],
        ),
        migrations.CreateModel(
            name='PatientCreate',
            fields=[
                ...
                ('patient_address', models.CharField(max_length=255, verbose_name='Bemorning manzili')),
                ('patient_age', models.IntegerField(verbose_name='Bemorning yoshi')),
                ('patient_blood', models.CharField(choices=[('α va β', 'birinchi (0)'), ('A va β', 'ikkinchi (A)'), ('α va B', 'uchinchi (B)'), ('A va B', 'toʻrtinchi (AB)')], max_length=255, verbose_name='Qon gruxi')),
                ('patient_status', models.CharField(choices=[('Vip', 'Vip'), ('Oddiy', 'Oddiy'), ('Budjet', ' Budjet')], max_length=255, verbose_name='Qabul holati')),
                ('patient_married', models.CharField(choices=[('Married', 'Married'), ('Unmarried', 'Unmarried')], max_length=255, verbose_name='Turmush holati')),
                ('patient_gender', models.CharField(choices=[('Ayol', 'Ayol'), ('Erkak', 'Erkak')], max_length=255, verbose_name='Jinsi')),
                ...
                ('patient_room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.rooms')),
            ],
        ),
        migrations.CreateModel(
            name='Operation',
